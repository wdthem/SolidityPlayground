...
def main():
    ...
    # approve sending ERC 20 token
    approve_erc20(amount, lending_pool.address, erc20_address, account)
    print("Depositing...")
    tx = lending_pool.deposit(
        erc20_address, amount, account.address, 0, {"from": account}
    )  # referral code is deprecated - always pass 0
    tx.wait(1)
    print("Deposited!")

    # how much to borrow? We want a positive health factor
    ...
    # multiply by 0.95 to improve health score somehow
...
def repay_all(amount, lending_pool, account):
    ...
    print(f"We are going to repay {amount}")
